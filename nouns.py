...
with option_expander:
    ...
    with col_declension:
        ...
        declension = st.multiselect("Choose which declensions to practice (they are all selected by default):", options=list(declension_dict.keys()), default=list(declension_dict.keys()))
